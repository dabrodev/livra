        ...
        <div className="w-full max-w-md">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-white/20">
                ...
                <p className="text-gray-300 text-center mb-8">
                    {isSignUp ? 'Sign up to create your AI personas' : 'Sign in to manage your AI personas'}
                </p>
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full bg-white text-gray-900 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 mb-6"
                >
